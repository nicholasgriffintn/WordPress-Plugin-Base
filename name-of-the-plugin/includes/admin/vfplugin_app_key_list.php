...
if ( !class_exists( 'vfplugin_SSO_App_List' ) && class_exists( 'WP_List_Table' ) ) {

	/**
	*
	*/
	class vfplugin_SSO_App_List extends WP_List_Table {
		...
		private function table_data() {
    		...
    		$actions = array(
  					...
  					'trash'    => sprintf('<a href="admin.php?page=uksjs-integration&action=trash&rule=%s">Trash</a>',$item['app_id'])
	...
	$list_obj = new vfplugin_SSO_App_List();
