...
if ( !class_exists( 'NGRIFFIN_PLUGIN_TokenGenerator' ) )
{
    class NGRIFFIN_PLUGIN_TokenGenerator
    {
        ...
        */
        public static function NGRIFFIN_PLUGIN_GENERATETOKEN($length = 32)
        {
            $token = '';
            $counter = 0;
            ...
            do {
                $token .= self::NGRIFFIN_PLUGIN_CRYPTORANDSECURE(0, $codeLength);
        ...
        */
        private static function NGRIFFIN_PLUGIN_CRYPTORANDSECURE($minValue = 0, $maxValue = 0)
        {
